...
function Sidebar({ isOpen }: Props) {
    return (
        <div className={`${isOpen ? "w-[70px]" : "w-[198px]"} border-r border-slate-300 hidden transition-all xl:block  bg-white shrink-0  dark:bg-gray-900 h-full dark:border-slate-600 `}>
            <div className={`${isOpen ? "px-2" : "px-5"}`}>
                <div className='flex logo-box h-[180px] '>
